...
# Сохраняем результат (СТРОКИ 110-130)
    ...
    if debug:
        ...
        plt.axvline(x=65, color='red', linestyle='--', label='Порог')  # Тот же порог, что в коде
...
if __name__ == "__main__":
    ...
    image_path = r"C:\Users\nutas\chip_10Hz_glass.jpg"  # Замените на путь к вашему файлу
